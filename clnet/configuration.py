...
default_num_threads = min(16, num_total_threads - 2)
...
default_load_from_decoder = False
default_warmup_epoch = 5
default_patch_size = [64, 160, 160]
...
default_pruning_eval_upper_percentile = 95
default_pruning_eval_lower_percentile = 5
default_pruning_repeat_times = 8
