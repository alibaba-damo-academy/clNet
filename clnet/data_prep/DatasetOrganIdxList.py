...
Task026_MSD_Pancreas = {
    0: "Background",
    1: "Pancreas",
    2: "Pancreas_GTV",
}

Task027_MSD_HepaticVessel = {
    0: "Background",
    1: "HepaticVessel",
    2: "Liver_GTV",
}
...
Task030_EsoCancer_WPY = {
    0: "Background",
    1: "Eso_GTV",
    2: "Eso",
}

Task035_LungCancer_WPY = {
    0: "Background",
    1: "Lung_GTV",
}
...
def combine_labels(list_of_datasets):
    list_of_dataset_name = {}
    for dataset in list_of_datasets:
        current_task = globals()[dataset]
        list_of_dataset_name[dataset] = current_task
    ret_label = {}
    offset = 0
    for dataset_name in list_of_dataset_name:
        dataset_offset = 0
        dataset = list_of_dataset_name[dataset_name]
        for label in dataset:
            if label == 0:
                continue
            ret_label[label + offset] = dataset_name + "_" + dataset[label]
            dataset_offset += 1
