...
import argparse
from clnet.postprocessing.consolidate_postprocessing import consolidate_folds
...
from clnet.paths import default_trainer, default_plans_identifier

default_cascade_trainer = None
