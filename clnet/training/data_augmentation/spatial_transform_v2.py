...
from clnet.training.data_augmentation.spatial_transformations_v2 import augment_spatial_v2, augment_spatial_2, \
...
class SpatialTransformV2(AbstractTransform):
    ...
    def __call__(self, **data_dict):
        ...
        ret_val = augment_spatial_v2(data, seg, patch_size=patch_size,
                                     ...
                                     scheme=self.scheme, dummy_2d=self.dummy_2d, orig_shape_data=orig_shape_data)
        data_dict[self.data_key] = ret_val[0]
        if seg is not None:
